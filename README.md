...
## Run
- this program is run locally by installing node , running npm install and npm run dev in the terminal inside the main folder
- Also hosted on vercell for Mobile/laptop cross platform ease of use
